...
public class ClientHooks
{
  ...
  {
    if ((event.entityItemFrame.func_82335_i() != null) && (!HelpfulVillagers.checkedFrames.contains(event.entityItemFrame)))
    {
      HelpfulVillagers.checkedFrames.add(event.entityItemFrame);
      HelpfulVillagers.network.sendToServer(new ItemFrameEventPacket(event.entityItemFrame.func_145782_y()));
    }
  }
